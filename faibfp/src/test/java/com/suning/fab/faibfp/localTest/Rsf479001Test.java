 ...
 * @Version 1.0
 */
public class Rsf479001Test extends TestUtil {
    ...
    public void test() {
        ...
        Map<String, Object> ret = rsf479001.execute(input);
    ...
    public void test2() {
        ...
        Map<String, Object> ret = rsf479010.execute(input);
        System.out.println("=============" + ret);
    }
}
