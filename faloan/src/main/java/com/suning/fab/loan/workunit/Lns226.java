...
@Scope("prototype")
@Repository
public class Lns226 extends WorkUnit { 
	...
	public void run() throws Exception {
		...
		lnsadjustinforeg.setBriefcode(ConstantDeclare.BRIEFCODE.LXHB);
		...
		sub.operate(lnsAcctInfo, null, tranAmt, la.getFundInvest(), ConstantDeclare.BRIEFCODE.LXHB, ctx);
		eventProvider.createEvent(ConstantDeclare.EVENT.NINTADJUST, tranAmt, lnsAcctInfo, null, la.getFundInvest(), ConstantDeclare.BRIEFCODE.LXHB, ctx, amtList,debtCompanyin,debtCompanyout);
