...
public class Tp472003 extends ServiceTemplate {
	...
	@Autowired Lns219 lns219; // 摊销冲销
	@Autowired Lns221 lns221; // 兼容以前老系统的数据冲销
	...
	protected void special() throws Exception {
		...
		if (VarChecker.asList(ConstantDeclare.RSPCODE.TRAN.IDEMPOTENCY).contains(ctx.getRspCode())) {
