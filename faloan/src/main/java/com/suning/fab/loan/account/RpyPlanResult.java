...
public class RpyPlanResult {
	...
	private FabAmount feeAmt= new FabAmount(0.00); //已还服务费
	private FabAmount noretFee= new FabAmount(0.00); //未还服务费
	private FabAmount termretFee= new FabAmount(0.00); //本期应还服务费
	private FabAmount penaltyAmt = new FabAmount(0.00); //已还违约金
	private FabAmount sumdelint = new FabAmount(0.00); //减免罚息
	private FabAmount sumdelfint = new FabAmount(0.00); //减免利息
	/**
	 * 
	 * @return the brc
	 */
