...
import com.suning.fab.loan.la.OpenAgreement;

public class OpenAgreementBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext context) {
		...
		BeanDefinitionBuilder def = BeanDefinitionBuilder
				.rootBeanDefinition(OpenAgreement.class);
