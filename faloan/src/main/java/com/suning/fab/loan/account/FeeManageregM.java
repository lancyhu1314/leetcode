...
public class FeeManageregM {
	...
	private Double termretfee;		//本期应还费用
	private Double feeamt;			//已还费用
	private Double noretfee;		//未还费用
	 ...
	 */
	public Double getTermretfee() {
		return termretfee;
	}
	/**
	 * @param termretfee the termretfee to set
	 */
	public void setTermretfee(Double termretfee) {
	 ...
	 * @return the noretfee
	 */
	public Double getNoretfee() {
		return noretfee;
	}
	/**
	 * @param noretfee the noretfee to set
	 */
	public void setNoretfee(Double noretfee) {
