 ...
 * @since [产品/模块版本] （可选）
 */
public class NonStaticFeeRepayPlanQuery extends RePayPlan {
	...
	private FabAmount penaltyamt = new FabAmount();//本期已还违约金
	private FabAmount noretpenalty = new FabAmount();//本期未还违约金
...
//    private FabAmount noretdamages = new FabAmount();		//未还违约金
	...
	public NonStaticFeeRepayPlanQuery() {
		super();
	}
