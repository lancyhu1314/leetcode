...
import com.suning.fab.loan.la.GrantAgreement;

public class GrantAgreementBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext context) {
		...
		BeanDefinitionBuilder def = BeanDefinitionBuilder
				.rootBeanDefinition(GrantAgreement.class);
